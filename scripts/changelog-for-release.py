...
Assets are attached below. Install help: [README](https://github.com/HaydernCenterpoint/grok-workspace#run-from-source). Full history: [CHANGELOG.md](https://github.com/HaydernCenterpoint/grok-workspace/blob/main/CHANGELOG.md)
"""
...
def main() -> int:
    ...
    out = f"# Grok Workspace v{version}\n\n{section}\n{FOOTER}"
    if not out.endswith("\n"):
        out += "\n"
    try:
