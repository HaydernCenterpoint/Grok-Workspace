...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            theme: "system".into(),
            // Follow OS language (Chinese tags currently resolve to en). Users can lock a catalog in Settings.
...
pub fn load_settings() -> AppSettings {
    ...
    // One-time: factory UI locale `en` → `system` so OS language (and other)
