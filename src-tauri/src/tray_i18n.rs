...
impl Locale {
    ...
    pub fn from_lang_tag(raw: &str) -> Self {
        ...
        // Chinese catalogs are parked; OS / settings tags fall back to English.
        if primary == "zh" {
            return Locale::En;
        }
...
mod tests {
    ...
    fn locale_parse() {
        ...
        assert_eq!(Locale::parse("zh"), Locale::En);
...
"#;
    ...
    fn from_lang_tag_maps_system_tags() {
        ...
        assert_eq!(Locale::from_lang_tag("zh_CN.UTF-8"), Locale::En);
        assert_eq!(Locale::from_lang_tag("zh-Hans-CN"), Locale::En);
        assert_eq!(Locale::from_lang_tag("zh-TW"), Locale::En);
        assert_eq!(Locale::from_lang_tag("zh-Hant-TW"), Locale::En);
        assert_eq!(Locale::from_lang_tag("zh-HK"), Locale::En);
