...
/// Compile Grok Office IR to a project .docx / .xlsx / .pptx (zip parts or raw bytes).
#[tauri::command]
pub async fn office_export(
    project_path: String,
    relative: String,
    entries: Option<Vec<crate::office_pack::OfficeZipEntry>>,
    bytes_base64: Option<String>,
) -> Result<crate::fs_browser::FsWriteResult, String> {
    tauri::async_runtime::spawn_blocking(move || {
        crate::office_pack::office_export(
            &project_path,
            &relative,
            entries.as_deref(),
