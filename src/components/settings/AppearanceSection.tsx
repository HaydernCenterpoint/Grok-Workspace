...
import { WORKBENCH_CHROMES } from "@/lib/workbenchChrome";
            ...
            {activeTab === "interface" && (
              <>
                ...
                <div
                  className={
                    "settings-card" +
                    rowHighlight("settings-anchor-workbenchChrome")
                  }
                  id="settings-anchor-workbenchChrome"
                >
                  <div className="settings-row">
                    <div className="settings-row__text">
                      <SettingsLabelWithTip
                        label={t("settings.workbenchChrome")}
                        tip={t("settings.workbenchChromeDesc")}
                      />
                    </div>
                    <div
                      className="settings-seg"
                      role="radiogroup"
                      aria-label={t("settings.workbenchChrome")}
                    >
                      {WORKBENCH_CHROMES.map((chrome) => (
                        <button
                          key={chrome}
                          type="button"
                          role="radio"
                          aria-checked={workbenchChrome === chrome}
                          className={
                            "settings-seg__btn" +
                            (workbenchChrome === chrome ? " is-on" : "")
                          }
                          onClick={() => onWorkbenchChrome(chrome)}
                        >
                          {t(`settings.workbenchChrome.${chrome}`)}
                        </button>
                      ))}
                    </div>
                  </div>
