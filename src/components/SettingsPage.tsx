...
export function SettingsPage({
  ...
  } = { section: sectionGate, tab: tabGate, onSection: onSectionGate, onBack: onBackGate, phoneLayout: phoneLayoutGate, locale: localeGate, focusAnchorId: focusAnchorIdGate, prHubHighlightPr: prHubHighlightPrGate, onFocusAnchorConsumed: onFocusAnchorConsumedGate, ...rest } as SettingsPageProps;
  ...
  const onWorkbenchChrome = useCallback((next: WorkbenchChrome) => {
    setWorkbenchChromeState(next);
    setWorkbenchChrome(next);
  }, []);
