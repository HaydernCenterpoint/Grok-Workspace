...
export function builtinSlashItems(): SlashItem[] {
  return [
    ...
    },
    {
      ...
      kind: "action",
      name: "office",
      titleKey: "slash.office",
      descriptionKey: "slash.officeDesc",
      action: "office",
    },
    {
      id: "studio",
      kind: "action",
      name: "studio",
      titleKey: "slash.studio",
      descriptionKey: "slash.studioDesc",
      action: "studio",
    },
    {
      id: "report",
      kind: "action",
      name: "report",
      titleKey: "slash.report",
      descriptionKey: "slash.reportDesc",
      action: "report",
      aliases: ["office-report", "code-report"],
    },
    {
      id: "live-voice",
      kind: "action",
