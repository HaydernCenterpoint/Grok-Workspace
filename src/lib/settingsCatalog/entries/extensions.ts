...
export const EXTENSIONS_ENTRIES: readonly SettingsEntry[] = [
  ...
  },
  {
    ...
    section: "extensions",
    tab: "skills",
    anchorId: "settings-anchor-ext-import",
    labelKey: "ext.import.btn",
    descKeys: [
      "ext.import.lead",
      "ext.import.honesty",
      "ext.import.btnHint",
  ...
  {
    id: "ext.skills.findInstalled",
    section: "extensions",
    tab: "skills",
    anchorId: "settings-anchor-ext-skills-find",
    labelKey: "ext.import.skillsFind",
    descKeys: ["ext.import.skillsFindHint"],
    keywords: [
      "find skills",
      "installed skills",
      "codex skills",
