...
export const GENERAL_ENTRIES: readonly SettingsEntry[] = [
  ...
  {
    id: "general.discordPresence",
    section: "general",
    tab: "app",
    anchorId: "settings-anchor-discordPresence",
    labelKey: "settings.discordPresence",
    descKeys: [
      "settings.discordPresenceDesc",
      "settings.discordPresence.clientId",
      "settings.discordPresence.clientIdDesc",
    ],
    keywords: [
      "discord",
      "rich presence",
