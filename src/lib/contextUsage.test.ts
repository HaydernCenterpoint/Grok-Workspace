...
describe("formatTokenCount", () => {
  it("handles edge and Chinese scale bands (百/千/万/亿)", () => {
    ...
    expect(formatTokenCount(100, "zh")).toBe("1百");
    expect(formatTokenCount(500, "zh")).toBe("5百");
    expect(formatTokenCount(999, "zh")).toBe("10百");
    expect(formatTokenCount(1000, "zh")).toBe("1千");
    expect(formatTokenCount(1500, "zh")).toBe("1.5千");
    expect(formatTokenCount(10_000, "zh")).toBe("1万");
    expect(formatTokenCount(12_400, "zh")).toBe("1.2万");
    expect(formatTokenCount(1_000_000, "zh")).toBe("100万");
    expect(formatTokenCount(1_500_000, "zh")).toBe("150万");
  });
...
describe("formatContextChipLabel", () => {
  it("prefixes estimate and uses em dash when unknown", () => {
    ...
    expect(formatContextChipLabel(1200, "known", "zh")).toBe("1.2千");
    expect(formatContextChipLabel(1200, "estimated", "zh")).toBe("~1.2千");
