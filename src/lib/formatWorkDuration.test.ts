...
describe("formatWorkDuration", () => {
  ...
  it("formats Japanese N分 N秒 style", () => {
    expect(formatWorkDuration(4, "ja")).toBe("4秒");
    expect(formatWorkDuration(60, "ja")).toBe("1分");
    expect(formatWorkDuration(69, "ja")).toBe("1分 9秒");
    expect(formatWorkDuration(125, "ja")).toBe("2分 5秒");
    expect(formatWorkDuration(3661, "ja")).toBe("1時間 1分 1秒");
  });
});
