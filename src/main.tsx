...
import { applyWorkMode, loadWorkMode } from "./lib/grokOffice";
import {
  applyChatWidth,
  loadChatWidth,
...
// Workbench chrome (Appearance) — html[data-chrome].
applyWorkbenchChrome(loadWorkbenchChrome(localStorage));
// Grok Office work mode — html[data-work-mode].
applyWorkMode(loadWorkMode(localStorage));
