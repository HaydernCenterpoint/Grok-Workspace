...
export const zhTWCore = {
  ...
  "app.versionFooter": "Grok v1.0.0 · MIT · 非 xAI 官方 · 姊妹專案 grok-go",
  "window.minimize": "最小化",
  "window.maximize": "最大化",
  "window.restore": "還原",
  "window.close": "關閉",
  ...
  "office.doc.invalid": "此 Office 文件不是有效 JSON。",
  "office.doc.exportMd": "儲存 Markdown",
  "office.doc.exportCsv": "儲存 CSV",
  "office.doc.exportDocx": "儲存 Word",
  "office.doc.exportXlsx": "儲存 Excel",
  "office.doc.exportPptx": "儲存 PowerPoint",
  "office.doc.exportOk": "已儲存 {name}",
  "office.doc.exportFail": "無法儲存 {name}",
  "office.doc.capture": "以 Office 文件開啟",
  "office.doc.captureOk": "已寫入 {name}",
  "office.doc.kind.paper": "報告",
  "office.doc.kind.sheet": "表格",
  "office.doc.kind.deck": "投影片",
  "office.doc.slideN": "第 {n} 張",
  "office.canvas.empty": "上方設計，下方輸入命令。",
  "office.canvas.blankPaper": "未命名報告",
  "office.canvas.blankSheet": "未命名表格",
  "office.canvas.blankDeck": "未命名投影片",
  "office.pane.pickFolder": "選擇資料夾",
  "studio.welcomeSlogan": "給我看點什麼",
  "studio.placeholder": "描述你想要的",
  "studio.image": "圖片",
  "studio.video": "影片",
  "studio.send": "生成",
  "studio.generating": "生成中…",
  "studio.err.empty": "請先輸入提示詞。",
  "studio.err.auth": "請登入官方 Grok 後再生成。",
  "studio.err.cli": "Imagine 需要 Grok Build CLI。",
  "studio.err.failed": "生成失敗，請換個提示詞。",
  "studio.aspect": "長寬比 {ratio}",
  "studio.res.480": "480p",
  "studio.res.720": "720p",
  ...
  "studio.dur.10": "10s",
  "studio.dur.15": "15s",
  "studio.kindGroup": "圖片或影片",
  "studio.resGroup": "解析度",
  "studio.durGroup": "時長",
  "studio.count": "圖片：{n}",
  "studio.countGroup": "圖片數量",
  "studio.count.1": "1 張",
  "studio.count.n": "{n} 張",
  "studio.aspect.poster": "海報",
  "studio.aspect.photo": "相片",
  "studio.aspect.presentation": "簡報",
  "studio.aspect.square": "方形",
  "studio.aspect.story": "限時動態",
  "studio.aspect.widescreen": "寬螢幕",
  "studio.aspect.cinematic": "電影",
  "studio.aspect.banner": "橫幅",
  "studio.aspect.portrait": "直式",
  "discord.presence.progress.idle": "空閒",
  "discord.presence.progress.working": "進行中",
  "discord.presence.progress.waiting": "等待中",
  "discord.presence.progress.connecting": "連線中",
  "discord.presence.package.none": "免費",
  "office.prevPage": "上一頁",
  "office.nextPage": "下一頁",
  "office.pageOf": "{page} / {total}",
  "image.view": "檢視大圖",
  "image.sendBuild": "傳送到 Grok Build",
  "image.sendOffice": "傳送到 Grok Office",
  "image.copy": "複製圖片",
