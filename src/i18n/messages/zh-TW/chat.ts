...
export const zhTWChat = {
  ...
  "main.welcomeSlogan": "把你的想法告訴我",
  "build.welcome.aria": "起步想法",
  "build.welcome.explore": "看看這個專案怎麼運作",
  "build.welcome.feature": "把想法寫成程式",
  "build.welcome.review": "審最近的改動",
  "build.welcome.fix": "把卡住的地方修好",
  "office.startTitle": "開始一次辦公工作階段",
  "office.welcomeSlogan": "文件、投影片和試算表",
  "office.startHint": "描述你需要的文件、投影片或試算表 — 檔案會在對話旁開啟。",
  "office.startTitleFromBuild": "以 {name} 進行工作",
  "office.startHintFromBuild": "此資料夾是 Grok Build 專案。可要求程式報告、簡報或投影片 — 助手會閱讀倉庫並在對話旁寫出文件。",
  "office.report": "撰寫專案報告",
  "office.start.report": "專案報告",
  "office.start.slides": "投影片大綱",
  "office.start.sheet": "追蹤表格",
