...
export const zhCore = {
  ...
  "app.versionFooter": "Grok v1.1.0 · MIT · 非 xAI 官方 · 姐妹项目 grok-go",
  "window.minimize": "最小化",
  "window.maximize": "最大化",
  "window.restore": "还原",
  "window.close": "关闭",
  ...
  "office.doc.invalid": "此 Office 文档不是有效 JSON。",
  "office.doc.exportMd": "保存 Markdown",
  "office.doc.exportCsv": "保存 CSV",
  "office.doc.exportDocx": "保存 Word",
  "office.doc.exportXlsx": "保存 Excel",
  "office.doc.exportPptx": "保存 PowerPoint",
  "office.doc.exportOk": "已保存 {name}",
  "office.doc.exportFail": "无法保存 {name}",
  "office.doc.capture": "作为 Office 文档打开",
  "office.doc.captureOk": "已写入 {name}",
  "office.doc.kind.paper": "报告",
  "office.doc.kind.sheet": "表格",
  "office.doc.kind.deck": "幻灯片",
  "office.doc.slideN": "第 {n} 页",
  "office.canvas.empty": "上方设计，下方输入命令。",
  "office.canvas.blankPaper": "未命名报告",
  "office.canvas.blankSheet": "未命名表格",
  "office.canvas.blankDeck": "未命名幻灯片",
  "office.pane.pickFolder": "选择文件夹",
  "studio.welcomeSlogan": "给我看点什么",
  "studio.placeholder": "描述你想要的",
  "studio.image": "图片",
  "studio.video": "视频",
  "studio.send": "生成",
  "studio.generating": "生成中…",
  "studio.err.empty": "请先输入提示词。",
  "studio.err.auth": "请登录官方 Grok 后再生成。",
  "studio.err.cli": "Imagine 需要 Grok Build CLI。",
  "studio.err.failed": "生成失败，请换个提示词。",
  "studio.aspect": "宽高比 {ratio}",
  "studio.res.480": "480p",
  "studio.res.720": "720p",
  ...
  "studio.dur.10": "10s",
  "studio.dur.15": "15s",
  "studio.kindGroup": "图片或视频",
  "studio.resGroup": "分辨率",
  "studio.durGroup": "时长",
  "studio.count": "图片：{n}",
  "studio.countGroup": "图片数量",
  "studio.count.1": "1 张",
  "studio.count.n": "{n} 张",
  "studio.aspect.poster": "海报",
  "studio.aspect.photo": "相片",
  "studio.aspect.presentation": "演示",
  "studio.aspect.square": "方形",
  "studio.aspect.story": "故事",
  "studio.aspect.widescreen": "宽屏",
  "studio.aspect.cinematic": "电影",
  "studio.aspect.banner": "横幅",
  "studio.aspect.portrait": "竖幅",
  "discord.presence.progress.idle": "空闲",
  "discord.presence.progress.working": "进行中",
  "discord.presence.progress.waiting": "等待中",
  "discord.presence.progress.connecting": "连接中",
  "discord.presence.package.none": "免费",
  "office.prevPage": "上一页",
  "office.nextPage": "下一页",
  "office.pageOf": "{page} / {total}",
  "image.view": "查看大图",
  "image.sendBuild": "发送到 Grok Build",
  "image.sendOffice": "发送到 Grok Office",
  "image.copy": "复制图片",
