...
export const zhSettings = {
  ...
  "settings.discordPresence": "在 Discord 显示状态",
  "settings.discordPresenceDesc": "Discord 桌面端运行时，显示套餐、剩余配额、模型与推理强度、当前会话和已用时长。好友能看到这些行。默认开启。",
  "settings.discordPresence.clientId": "Discord 应用 ID",
  "settings.discordPresence.clientIdDesc": "Discord 显示的是这个应用的名称。在 Discord 开发者后台创建一个名为 Grok App 的应用，然后把 Application ID 贴到这里。",
  "settings.discordPresence.clientIdPlaceholder": "Application ID",
  "settings.discordPresence.status.off": "已关闭 — Discord 不会显示本应用。",
  "settings.discordPresence.status.live": "已连接 — Discord 正在显示本应用。",
  "settings.discordPresence.status.needRebuild": "当前 Host 过旧 — 请完全退出 Grok App 再启动，Discord 状态才能加载。",
  "settings.discordPresence.status.noDiscord": "Discord 桌面端未运行，或当前动态被隐藏（隐身 / 动态隐私）。",
  "settings.discordPresence.status.needApp": "Discord 拒绝了 Application ID。请在开发者后台创建名为 Grok App 的应用，并把 ID 贴到上方。",
  "settings.discordPresence.status.failed": "无法更新 Discord 状态。",
  ...
  "settings.uiFontDesc": "侧栏、聊天与设置等 UI 字体（不含内置终端）。留空使用内置 Inter。",
  "settings.uiFontPh": "例如 Inter、Segoe UI、system-ui",
  "settings.uiFontHint": "留空使用内置 Inter。请填写本机已安装的字体族名称。",
  ...
  "settings.workbenchChrome": "工作台外观",
  "settings.workbenchChromeDesc": "Codex 实色外壳、底部输入框，或经典悬浮输入框与毛玻璃",
  "settings.workbenchChrome.codex": "Codex",
  "settings.workbenchChrome.classic": "经典",
  "settings.chatWidth": "对话阅读宽度",
  "settings.chatWidthDesc": "会话消息区最大宽度。Grok Build / Office / Studio 始终跟输入框卡片对齐。",
