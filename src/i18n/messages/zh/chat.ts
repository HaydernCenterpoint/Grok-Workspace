...
export const zhChat = {
  ...
  "main.welcomeSlogan": "把你的想法告诉我",
  "build.welcome.aria": "起步想法",
  "build.welcome.explore": "看看这个项目怎么运转",
  "build.welcome.feature": "把想法写成代码",
  "build.welcome.review": "审最近的改动",
  "build.welcome.fix": "把卡住的地方修好",
  "office.startTitle": "开始一次办公会话",
  "office.welcomeSlogan": "文档、幻灯片和表格",
  "office.startHint": "描述你需要的文档、幻灯片或表格 — 文件会在聊天旁打开。",
  "office.startTitleFromBuild": "基于 {name} 工作",
  "office.startHintFromBuild": "此文件夹是 Grok Build 项目。可要求代码报告、简报或幻灯片 — 助手会阅读仓库并在聊天旁写出文档。",
  "office.report": "撰写项目报告",
  "office.start.report": "项目报告",
  "office.start.slides": "幻灯片大纲",
  "office.start.sheet": "跟踪表格",
