...
export const enChat = {
  ...
  "main.welcomeSlogan": "Tell me your idea",
  "build.welcome.aria": "Starter ideas",
  "build.welcome.explore": "See how this project works",
  "build.welcome.feature": "Turn your idea into code",
  "build.welcome.review": "Review the latest changes",
  "build.welcome.fix": "Unstick a failure",
  "office.startTitle": "Start a work session",
  "office.welcomeSlogan": "Papers, slides, and sheets",
  "office.startHint": "Ask for a document, slides, or a spreadsheet — the canvas above the composer updates as files are written.",
  "office.startTitleFromBuild": "Work from {name}",
  "office.startHintFromBuild": "This folder is the Grok Build project. Ask for a code report, brief, or slides — the agent reads the repo and writes documents beside the chat.",
  "office.report": "Write project report",
  "office.start.report": "Project report",
  "office.start.slides": "Slide outline",
