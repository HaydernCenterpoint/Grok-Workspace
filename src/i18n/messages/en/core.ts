...
export const enCore = {
  ...
  "app.versionFooter": "Grok v1.0.0 · MIT · Unofficial · Sister project grok-go",
  ...
  "office.doc.invalid": "This Office document is not valid JSON.",
  "office.doc.exportMd": "Save Markdown",
  "office.doc.exportCsv": "Save CSV",
  "office.doc.exportDocx": "Save Word",
  "office.doc.exportXlsx": "Save Excel",
  "office.doc.exportPptx": "Save PowerPoint",
  "office.doc.exportOk": "Saved {name}",
  "office.doc.exportFail": "Could not save {name}",
  "office.doc.capture": "Open as Office document",
  "office.doc.captureOk": "Wrote {name}",
  "office.doc.kind.paper": "Report",
  "office.doc.kind.sheet": "Sheet",
  "office.doc.kind.deck": "Slides",
  "office.doc.slideN": "Slide {n}",
  "office.canvas.empty": "Design above. Type a command below.",
  "office.canvas.blankPaper": "Untitled report",
  "office.canvas.blankSheet": "Untitled sheet",
  "office.canvas.blankDeck": "Untitled slides",
  "office.pane.pickFolder": "Choose folder",
  "studio.welcomeSlogan": "Show me something",
  "studio.placeholder": "Describe what you want",
  "studio.image": "Image",
  "studio.video": "Video",
  "studio.send": "Generate",
  "studio.generating": "Generating…",
  "studio.err.empty": "Enter a prompt first.",
  "studio.err.auth": "Sign in with official Grok to generate.",
  "studio.err.cli": "Grok Build CLI is required for Imagine.",
  "studio.err.failed": "Generation failed. Try another prompt.",
  ...
  "discord.presence.progress.working": "Working",
  "discord.presence.progress.waiting": "Waiting",
  "discord.presence.progress.connecting": "Connecting",
  "discord.presence.package.none": "Free",
  "office.prevPage": "Previous",
  "office.nextPage": "Next",
  "office.pageOf": "{page} / {total}",
  "image.view": "View image",
  "image.sendBuild": "Send to Grok Build",
  "image.sendOffice": "Send to Grok Office",
